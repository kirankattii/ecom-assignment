...
const products = [
    {
        ...
        description: "The most powerful MacBook Pro ever. Featuring the M4 Max chip with a 16-core CPU and 40-core GPU, 48GB unified memory, and a stunning 16.2-inch Liquid Retina XDR display. Perfect for professionals who demand the ultimate in performance for video editing, 3D rendering, and software development.",
        category: "Laptops",
        price: 3499.0,
        stock: 25,
        images: [
    ...
    },
    {
        ...
        description: "Industry-leading noise cancellation meets premium sound quality. The WH-1000XM6 features 40mm drivers with LDAC support, 40-hour battery life, adaptive sound control, and ultra-comfortable memory foam ear cushions. Speak-to-chat and multipoint connection make these the perfect everyday companion.",
        category: "Audio",
        price: 399.99,
        stock: 120,
        images: [
    ...
    },
    {
        ...
        description: "The ultimate smartphone experience with a 6.9-inch Dynamic AMOLED 2X display, Snapdragon 8 Elite processor, 200MP main camera with advanced AI photography features, built-in S Pen, and a massive 5000mAh battery. Galaxy AI brings intelligent assistance to your fingertips with real-time translation and generative editing.",
    ...
    },
    {
        ...
        description: "Dyson's most intelligent vacuum with a piezo sensor that counts and sizes microscopic particles, showing proof of a deep clean on the LCD screen. The laser slim fluffy cleaner head reveals invisible dust on hard floors. Features 240 air watts of powerful suction and up to 60 minutes of fade-free runtime.",
    ...
    },
    {
        ...
        description: "The premium Kindle reading experience with a 7-inch glare-free 300ppi display, adjustable warm light, auto-adjusting front light sensor, wireless charging, and 32GB of storage. IPX8 waterproof rated so you can read by the pool or in the bath. A single charge lasts up to 12 weeks.",
        category: "Electronics",
        price: 189.99,
        stock: 150,
        images: [
    ...
    },
    {
        ...
        description: "The award-winning Atmos AG 65 features Osprey's Anti-Gravity suspension system that distributes weight evenly across the entire back panel for unmatched comfort on long treks. Includes a built-in raincover, Stow-on-the-Go trekking pole attachment, multiple access points, and a removable floating top lid that converts to a daypack. Capacity: 65 liters.",
    ...
    },
    {
        ...
        description: "Craft café-quality espresso at home with the Barista Express Impress. Features an Assisted Tamping system for consistent extraction, integrated conical burr grinder with 25 settings, digital temperature control, a 2-liter water tank, and a powerful 15-bar Italian pump. Includes a steam wand for microfoam milk texturing and latte art.",
